...
@section('content')
    <div class="flex justify-center items-center px-4 py-24 min-h-screen bg-gray-800 dark:bg-gray-900 dark:text-gray-100 sm:px-6 lg:px-8">
        <div class="space-y-8 w-full max-w-lg">
            ...
            <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    ...
                    <div class="mt-3 mb-3">
                        <label for="avatar" class="sr-only">Select your image (optional)</label>
                ...
                <div>
                    <button type="submit" class="flex relative justify-center px-6 py-3 w-full text-lg font-medium text-white bg-indigo-600 rounded-md border border-transparent dark:bg-indigo-500 group hover:bg-indigo-700 dark:hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            <div>
                <a href="{{ route('login') }}" type="submit" class="flex relative justify-center px-6 py-3 w-full text-lg font-medium text-white bg-indigo-600 rounded-md border border-transparent dark:bg-indigo-500 group hover:bg-indigo-700 dark:hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    <span class="flex absolute inset-y-0 left-0 items-center pl-3">
                        <svg class="w-6 h-6 text-indigo-400 group-hover:text-indigo-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 12a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                            <path fill-rule="evenodd" d="M4 8a6 6 0 1112 0v4a2 2 0 01-2 2H6a2 2 0 01-2-2V8zm10-2V5a4 4 0 10-8 0v1H4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V8a2 2 0 00-2-2h-2z" clip-rule="evenodd" />
